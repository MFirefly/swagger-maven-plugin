...
public class SwaggerReaderTest extends AbstractMojoTestCase {
    ...
    @Test
    private void assertGeneratedSwaggerSpecJs() throws Exception {
        ...
        String expectJs = IOUtils.toString(this.getClass().getResourceAsStream("/expectedOutput/swagger-swaggerreader.js"));
